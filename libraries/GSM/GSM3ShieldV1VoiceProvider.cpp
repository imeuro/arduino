...
{
	theGSM3ShieldV1ModemCore.genericCommand_rqp(PSTR("ATD"),false);
...
void GSM3ShieldV1VoiceProvider::retrieveCallingNumberContinue()
{
    ...
    case 1:	
		theGSM3ShieldV1ModemCore.genericCommand_rqp(PSTR("AT+CLCC"));
...
void GSM3ShieldV1VoiceProvider::answerCallContinue()
{
    ...
    case 1:
		// ATA ;
		theGSM3ShieldV1ModemCore.genericCommand_rqp(PSTR("ATA"));
		theGSM3ShieldV1ModemCore.setCommandCounter(2);
		break;
	case 2:
...
void GSM3ShieldV1VoiceProvider::hangCallContinue()
{
    ...
    case 1:
		//ATH
		theGSM3ShieldV1ModemCore.genericCommand_rqp(PSTR("ATH"));
		theGSM3ShieldV1ModemCore.setCommandCounter(2);
		break;
	case 2:
		if(theGSM3ShieldV1ModemCore.genericParse_rsp(resp))
