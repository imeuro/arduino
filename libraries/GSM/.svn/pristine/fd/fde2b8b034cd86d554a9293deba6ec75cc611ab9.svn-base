...
void GSM3ShieldV1SMSProvider::beginSMSContinue()
{
    ...
    case 1:
		...
		theGSM3ShieldV1ModemCore.genericCommand_rqp(PSTR("AT+CMGS=\""), false);
...
void GSM3ShieldV1SMSProvider::availableSMSContinue()
{
	...
	switch (theGSM3ShieldV1ModemCore.getCommandCounter()) {
    case 1:	
		theGSM3ShieldV1ModemCore.genericCommand_rqp(PSTR("AT+CMGL=\"REC UNREAD\",1"));
		theGSM3ShieldV1ModemCore.setCommandCounter(2);
		break;
	case 2:
...
void GSM3ShieldV1SMSProvider::flushSMSContinue()
{
    ...
    case 1:
		theGSM3ShieldV1ModemCore.setCommandCounter(2);
		theGSM3ShieldV1ModemCore.genericCommand_rqp(PSTR("AT+CMGD="), false);
