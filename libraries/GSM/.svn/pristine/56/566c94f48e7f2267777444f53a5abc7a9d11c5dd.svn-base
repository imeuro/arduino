...
void GSM3ShieldV1CellManagement::getLocationContinue()
{
    ...
    case 1:
		...
		theGSM3ShieldV1ModemCore.genericCommand_rqp(PSTR("AT+QENG=1"), false);
	...
	case 2:
		if (theGSM3ShieldV1ModemCore.genericParse_rsp(resp))
		{
			...
			theGSM3ShieldV1ModemCore.genericCommand_rqp(PSTR("AT+QENG?"), false);
			theGSM3ShieldV1ModemCore.print("\r");
		}
...
void GSM3ShieldV1CellManagement::getICCIDContinue()
{
    ...
    case 1:
		theGSM3ShieldV1ModemCore.setCommandCounter(2);
		theGSM3ShieldV1ModemCore.genericCommand_rqp(PSTR("AT+QCCID"), false);
		theGSM3ShieldV1ModemCore.print("\r");
		break;
	case 2:
		if (theGSM3ShieldV1ModemCore.genericParse_rsp(resp))
