...
void GSM3ShieldV1MultiClientProvider::connectTCPClientContinue()
{
	...
	case 1:
		theGSM3ShieldV1ModemCore.genericCommand_rqp(PSTR("AT+QIDNSIP="), false);
	...
	case 2:
		if(theGSM3ShieldV1ModemCore.genericParse_rsp(resp))
	    {
			...
			{				
				// AT+QIOPEN
				theGSM3ShieldV1ModemCore.genericCommand_rqp(PSTR("AT+QIOPEN="),false);
...
void GSM3ShieldV1MultiClientProvider::disconnectTCPContinue()
{
	...
	switch (theGSM3ShieldV1ModemCore.getCommandCounter()) {
	case 1:
		theGSM3ShieldV1ModemCore.genericCommand_rqp(_command_MultiQISRVC, false);
	...
	case 2:
		...
		if(resp)
		{
			...
			theGSM3ShieldV1ModemCore.genericCommand_rqp(PSTR("AT+QICLOSE="),false);
			theGSM3ShieldV1ModemCore.print(idSocket);
			theGSM3ShieldV1ModemCore.print('\r');
			theGSM3ShieldV1ModemCore.setCommandCounter(3);
		}
...
void GSM3ShieldV1MultiClientProvider::beginWriteSocketContinue()
{
    ...
    case 2:
		if(theGSM3ShieldV1ModemCore.genericParse_rsp(resp))
		{
			...
			{
				// AT+QISEND
				theGSM3ShieldV1ModemCore.genericCommand_rqp(PSTR("AT+QISEND="), false);
				theGSM3ShieldV1ModemCore.print(idSocket);
				theGSM3ShieldV1ModemCore.print('\r');
				theGSM3ShieldV1ModemCore.setCommandCounter(3);
			}
...
void GSM3ShieldV1MultiClientProvider::availableSocketContinue()
{
	...
	switch (theGSM3ShieldV1ModemCore.getCommandCounter()) {
	case 1:
		theGSM3ShieldV1ModemCore.genericCommand_rqp(PSTR("AT+QIRD=0,"),false);
		if (client1_server0) 
			theGSM3ShieldV1ModemCore.print('1');
		else 
			theGSM3ShieldV1ModemCore.print('2');
